...
const PICKUPPABLE_ITEM_SCENES := {
	Keys.Stick : "res://interactables/pickuppables/pickuppable_stick.tscn",
	Keys.Stone : "res://interactables/pickuppables/pickuppable_stone.tscn",
	Keys.Plant : "res://interactables/pickuppables/pickuppable_plant.tscn",
	Keys.Mushroom : "res://interactables/pickuppables/pickuppable_mushroom.tscn",
	Keys.Fruit : "res://interactables/pickuppables/pickuppable_fruit.tscn",
...
static func has_pickuppable_scene(item_key: Keys) -> bool:
	return item_key in PICKUPPABLE_ITEM_SCENES
