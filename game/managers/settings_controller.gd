...
func _enter_tree() -> void:
	EventSystem.connect_once("SET_music_volume_changed", Callable(self, "music_volume_changed"))
	EventSystem.connect_once("SET_sfx_volume_changed", Callable(self, "sfx_volume_changed"))
	EventSystem.connect_once("SET_res_scale_changed", Callable(self, "res_scale_changed"))
	EventSystem.connect_once("SET_ssaa_changed", Callable(self, "ssaa_changed"))
	EventSystem.connect_once("SET_fullscreen_changed", Callable(self, "fullscreen_changed"))
	EventSystem.connect_once("SET_ask_settings_resource", Callable(self, "send_settings_resource"))

	EventSystem.connect_once("SET_save_settings", Callable(self, "save_settings"))
