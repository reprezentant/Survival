...
func _input(event): # All major mouse and button input events
	...
	if event.is_action_pressed("use_equipped_item"): # Use equipped item instead of aim
...
#	Jump input and Mechanics
	...
	if Input.is_action_pressed("use_equipped_item"):  # Use equipped item instead of aim
